...
Public Class FRNNOTASERVICIOREIMPRESION
    Private Sub FRNNOTASERVICIOREIMPRESION_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        conexionMysql.Open()
        Dim sqlxx As String
        sqlxx = "select idcliente from venta where idventa=" & frmindex.rptidservicio.Text & ";"
        ...
        Dim ds24 As DataSet
        Dim Sql24 As String
        Sql24 = "select nombre,ap,am,direccion,telefono,correo,rfc from cliente where idcliente=" & idcliente & ";"
        ...
        Dim ds25 As DataSet
        Dim Sql25 As String
        Sql25 = "SELECT tipo_pago.tipo from tipo_pago,venta where tipo_pago.idtipo_pago=venta.idtipo_pago and venta.idventa=" & frmindex.rptidservicio.Text & ";"
