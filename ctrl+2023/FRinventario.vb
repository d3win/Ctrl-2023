...
Public Class FRinventario
    Private Sub FRinventario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim ds As DataSet
        Dim Sql As String
        Sql = "SELECT producto.idproducto,producto.descripcion,producto.cantidad,producto.costo,producto.precio,producto.preciom,proveedor.nombre_empresa  FROM proveedor, PRODUCTO where proveedor.idproveedor=producto.idproveedor ORDER BY proveedor.nombre_empresa;"
        ...
        Dim rds As New ReportDataSource("dsinventario", ds.Tables(0))
    ...
    Private Sub FRinventario_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
