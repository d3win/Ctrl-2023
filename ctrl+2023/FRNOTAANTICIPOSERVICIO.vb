...
Public Class FRNOTAANTICIPOSERVICIO
    Private Sub FRNOTAANTICIPOSERVICIO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub FRNOTAANTICIPOSERVICIO_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
