...
Public Class FRNOTACOMPRAMERCANCIA
    Private Sub FRNOTACOMPRAMERCANCIA_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub FRNOTACOMPRAMERCANCIA_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
