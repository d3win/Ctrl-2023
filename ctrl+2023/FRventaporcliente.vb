...
Public Class FRventaporcliente
    ...
    Private Sub FRventaporcliente_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Function cargardatos()
        ...
        Sql = "select idventa,fecha,hora from venta where idcliente=" & idcliente & " and tipoventa=2 ;"
        Dim cmd As New MySqlCommand(Sql, conexionMysql)
    ...
    Private Sub Button78_Click(sender As Object, e As EventArgs) Handles Button78.Click
        frmindex.stxtfoliobusquedaventa.Text = stxtfolio.Text
        Me.Close()
