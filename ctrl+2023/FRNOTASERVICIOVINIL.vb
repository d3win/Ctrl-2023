...
Public Class FRNOTASERVICIOVINIL
    Private Sub FRNOTASERVICIOVINIL_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim ds As DataSet
        Dim Sql As String
        Sql = "select venta.idventa, (venta.cantidad)as cantidad1,venta.total,venta.fecha,venta.hora,venta.fechaentrega,venta.anticipo,venta.resto,venta.idsecotizacion, ventaind.actividad,(ventaind.cantidad)as cantidad2,ventaind.costo,ventaind.descripcion, ventaind.idproducto, (ventaind.costo * ventaind.cantidad)as total2, ventaind.ancho, ventaind.alto, ventaind.cm2  from venta,ventaind where venta.idventa=ventaind.idventa and venta.idventa=" & idventa & ";"
        ...
        Sql255 = "SELECT tipo_pago.tipo from tipo_pago,venta where tipo_pago.idtipo_pago=venta.idtipo_pago and venta.idventa=" & idventa & ";"
        ...
        Dim rds As New ReportDataSource("dsserviciovinil", ds.Tables(0))
        ...
        ReportViewer1.LocalRep> ort.DataSources.Add(rds5)
    ...
    Private Sub FRNOTASERVICIOVINIL_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
