...
Public Class FRcerrarcaja
    ...
    Private Sub Txtdeberialexistir_TextChanged(sender As Object, e As EventArgs) Handles txtdeberialexistir.TextChanged

    End Sub

    Private Sub Txttotalproductos_TextChanged(sender As Object, e As EventArgs) Handles txttotalproductos.TextChanged
    ...
    Private Sub Txtcomprastotales_TextChanged(sender As Object, e As EventArgs) Handles txtcomprastotales.TextChanged
    ...
    Private Sub Txtcompramercancia_TextChanged(sender As Object, e As EventArgs) Handles txtcompramercancia.TextChanged
    ...
    Private Sub Txtcompras_TextChanged(sender As Object, e As EventArgs) Handles txtcompras.TextChanged
    ...
    Private Sub Txttotalfinalventas_TextChanged(sender As Object, e As EventArgs) Handles txttotalfinalventas.TextChanged
    ...
    Private Sub Txtanticipos_TextChanged(sender As Object, e As EventArgs) Handles txtanticipos.TextChanged
    ...
    Private Sub Txtventasproductos_TextChanged(sender As Object, e As EventArgs) Handles txtventasproductos.TextChanged
    ...
    Private Sub ChAnticipos_CheckedChanged(sender As Object, e As EventArgs) Handles ChAnticipos.CheckedChanged

    End Sub

    Private Sub Chproductosvendidos_CheckedChanged(sender As Object, e As EventArgs) Handles chproductosvendidos.CheckedChanged

    End Sub

    Private Sub Chproductoscomprados_CheckedChanged(sender As Object, e As EventArgs) Handles chproductoscomprados.CheckedChanged
    ...
    Private Sub Txtventavales_TextChanged(sender As Object, e As EventArgs) Handles txtventavales.TextChanged
    ...
    Private Sub Txtventastarjeta_TextChanged(sender As Object, e As EventArgs) Handles txtventastarjeta.TextChanged
    ...
    Private Sub Txtventastransferencias_TextChanged(sender As Object, e As EventArgs) Handles txtventastransferencias.TextChanged
    ...
    Private Sub Txtventasefectivo_TextChanged(sender As Object, e As EventArgs) Handles txtventasefectivo.TextChanged
    ...
    Private Sub Lbfechacierre_Click(sender As Object, e As EventArgs) Handles lbfechacierre.Click

    End Sub

    Private Sub Lbfechaapertura_Click(sender As Object, e As EventArgs) Handles lbfechaapertura.Click
    ...
    Private Sub Pblogoticket_Click(sender As Object, e As EventArgs) Handles pblogoticket.Click
