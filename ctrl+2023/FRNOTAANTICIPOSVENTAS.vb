...
where  cliente.idcliente = servicios_ventas.idcliente and servicios_ventas.fecha between '" & fecha & "' and '" & fechafinal & "';"
        ...
        Dim rds4 As New ReportDataSource("dsanticiposventas", ds24.Tables(0))
    ...
    Private Sub FRNOTAANTICIPOSVENTAS_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
