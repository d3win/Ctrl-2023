...
Public Class FRagregaranticipovinil
    Dim id As String

    Private Sub FRagregaranticipovinil_Load(sender As Object, e As EventArgs) Handles MyBase.Load




        'Me.Label2.Text = frmcotizadorvinil.stxtfoliobusquedaventa.Text

        'Label2.Text = frmcotizadorvinil.folioventa

        '        MsgBox(idvinil)


        '        Label2.Text =
        '       id = frmcotizadorvinil.stxtfoliobusquedaventa.Text
    ...
    Function sumaranticipo()
        ...
        Else
            ...
            Dim Sql2X As String
            Sql2X = "insert into servicios_ventas (idventa,fecha, hora, idcliente,anticipo,total) values('" & idvinil & "', '" & fecha & "', '" & hora & "','" & idvinilusuario & "'," & txtcantidad.Text & "," & total & " )"
            ...
            conexionMysql.Open()
            Dim sql22 As String
            sql22 = "UPDATE venta SET anticipo=" & anticipo & ", resto=" & resto & "  WHERE idventa='" & idvinil & "';"
            ...
            frmcotizadorvinil.stxtresto1.Text = resto
    ...
    Private Sub FRagregaranticipovinil_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        ' idvinilbusquedaventa = idvinil
        frmcotizadorvinil.reiniciar()
        'frmcotizadorvinil.buscarfolioservicio()
    End Sub

    Private Sub FRagregaranticipovinil_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        'frmcotizadorvinil.buscarfolioservicio()
        frmcotizadorvinil.reiniciar()
    ...
    Private Sub GroupBox1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles GroupBox1.KeyPress
