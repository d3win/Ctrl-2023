...
Public Class FRNOTACOMPRAS
    Private Sub FRNOTACOMPRAS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim ds24 As DataSet
        Dim Sql24 As String
        Sql24 = "select * from compra where fecha='" & fechacompleta & "';"
        ...
        Dim rds4 As New ReportDataSource("dscompra", ds24.Tables(0))
    ...
    Private Sub FRNOTACOMPRAS_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
