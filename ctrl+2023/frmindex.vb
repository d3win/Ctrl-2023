...
ADD COLUMN `respaldo_auto` INT NULL AFTER `mostrar_corte`;"
            Dim cmd As New MySqlCommand(Sql, conexionMysql)
            cmd.ExecuteNonQuery()
            conexionMysql.Close()
        Catch
  ...
  PRIMARY KEY (`idagenda`));"
        ...
        '----------------------------------------------------
        ''250621- AGREGAMOS UNA COLUMNA TABLA servicios_Ventas PARA QUE ALMACENEMOS EL RESTO
...
ADD COLUMN `saludo_ticket` VARCHAR(45) NULL AFTER `rfc`,
CHANGE COLUMN `rfc` `rfc` VARCHAR(45) NULL DEFAULT NULL ;"
            Dim cmd As New MySqlCommand(Sql, conexionMysql)
            cmd.ExecuteNonQuery()
            conexionMysql.Close()
        Catch
...
ADD COLUMN `resto` DOUBLE NULL AFTER `total`;"
            Dim cmd As New MySqlCommand(Sql, conexionMysql)
            cmd.ExecuteNonQuery()
            conexionMysql.Close()
        Catch
        ...
        '----------------------------------------------------
        ''250621- MODIFICAMOS LA FECHA DE LA TABLA servicios_Ventas PARA QUE ACEPTE LA HORA DE VENTA
        cerrarconexion()
...
CHANGE COLUMN `fecha` `fecha` DATETIME NULL DEFAULT NULL ;"
        ...
        '----------------------------------------------------
        ''220621- MODIFICAMOS LA FECHA DE LA TABLA VENTA PARA QUE ACEPTE LA HORA DE VENTA
        cerrarconexion()
...
CHANGE COLUMN `fecha` `fecha` DATETIME NULL DEFAULT NULL ;"
        ...
        '----------------------------------------------------
        ''agregamos un atributo para almacenar la ganancia de las ventas
        cerrarconexion()
...
ADD COLUMN `ganancia` DOUBLE NULL AFTER `diferencia`,
ADD COLUMN `fecha_cierre` DATE NULL AFTER `ganancia`;
"
            Dim cmd As New MySqlCommand(Sql, conexionMysql)
            cmd.ExecuteNonQuery()
            conexionMysql.Close()
        ...
        '----------------------------------------------------
        ''agregamos un atributo para el tipo de fuente entre arial y times new roman
        cerrarconexion()
...
ADD COLUMN `f_tipo` VARCHAR(45) NULL AFTER `f_contenido`;"
        ...
        Try
            ...
            Dim Sql As String
            Sql = "ALTER TABLE `dwin`.`datos_empresa` 
ADD COLUMN `f_titulo` INT NULL AFTER `saludo_ticket`,
ADD COLUMN `f_contenido` INT NULL AFTER `f_titulo`
;"
            Dim cmd As New MySqlCommand(Sql, conexionMysql)
            cmd.ExecuteNonQuery()
            conexionMysql.Close()
        ...
        Try
            ...
            conexionMysql.Open()
            Dim Sql As String
            Sql = "select f_titulo from datos_empresa;"
            Dim cmd2 As New MySqlCommand(Sql, conexionMysql)
            reader = cmd2.ExecuteReader()
            reader.Read()
        ...
        If valor2 = "" Then
            ...
            Try
                conexionMysql.Open()
                Dim Sql As String
                Sql = "UPDATE `dwin`.`datos_empresa` SET `f_titulo` = '10', `f_contenido` = '9', `f_tipo` = 'Arial'  WHERE (`iddatos_empresa` = '1');"
                Dim cmd As New MySqlCommand(Sql, conexionMysql)
                cmd.ExecuteNonQuery()
                conexionMysql.Close()
            Catch
...
"
    ...
    Function obtener_chticket_Chcambio_venta()
        ...
        Try
            ...
            Dim valorticket, valorcambio, MostrarCorte, respaldoAuto As String
            conexionMysql.Open()
            Dim Sql111 As String
            Sql111 = "select obligarticket,obligarcambio,mostrar_corte, respaldo_auto from datos_empresa;"
            Dim cmd111 As New MySqlCommand(Sql111, conexionMysql)
            reader = cmd111.ExecuteReader()
            reader.Read()
            ...
            respaldoAuto = reader.GetString(3).ToString
...
"
    ...
    Function cargarDatosCorte()
        ...
        Try
            ...
            Try
                conexionMysql.Open()
                Dim sql1c As String
                sql1c = "select sum(totalcompra)  from compramercancia where fecha between '" & fechainicial & "' and '" & fechafinal & "';"
                Dim cmd1c As New MySqlCommand(sql1c, conexionMysql)
                reader = cmd1c.ExecuteReader
                reader.Read()
                'cbtncompras.Text = reader.GetString(0).ToString()
                cbtncompras.Text = reader.GetString(0).ToString()
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        GroupBox14.Text = "Información del corte"
        obtener_chticket_Chcambio_venta()
    ...
    Function consultacortecalendario()
        ...
        'MsgBox(fecha)
        'where fecha >='2021-06-26' and fecha<='2021-06-26 24:59:59'
        Try
            conexionMysql.Open()
            Dim sql1 As String
        ...
        Try
            ...
            Sql3 = "select sum(total) from venta where fecha>='" & fecha & "' and fecha<='" & fechafinal & "'  and tipoventa=1;"
        ...
        cbtnventas.Text = CDbl(sumatotalventa)
        ...
        Try
            ...
            cbttotales.Text = (CDbl(cbtnventas.Text) + CDbl(cbtnanticipos.Text)) - CDbl(txtgastos.Text)
            '= suma - CDbl(txtgastos.Text)
        Catch ex As Exception
    ...
    Function tipo_corte_configuracion()
        ...
        If conta = 0 Then
            ...
            conexionMysql.Open()
            Dim Sql2 As String
            Sql2 = "INSERT INTO `tipo_corte` (`idtipo_corte`, `tipo`, `estado`) VALUES ('1', 'USUARIO', '1');"
            Dim cmd2 As New MySqlCommand(Sql2, conexionMysql)
            cmd2.ExecuteNonQuery()
            conexionMysql.Close()
            conexionMysql.Open()
            Dim Sql22 As String
            Sql22 = "INSERT INTO `tipo_corte` (`idtipo_corte`, `tipo`, `estado`) VALUES ('2', 'TIEMPO', '0');"
            Dim cmd22 As New MySqlCommand(Sql22, conexionMysql)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Try
            ...
            prFont = New Font(f_tipo, tfuente2, FontStyle.Bold)
            e.Graphics.DrawString("FOLIO:" & lbfolio.Text, prFont, Brushes.Black, p3, yy(12))
            prFont = New Font(f_tipo, tfuente, FontStyle.Bold)
...
INSERT INTO `tipo_pago` (`idtipo_pago`, `tipo`) VALUES ('2', 'DEPOSITO');
INSERT INTO `tipo_pago` (`idtipo_pago`, `tipo`) VALUES ('3', 'TRANSFERENCIA');
;"
    ...
    Private Sub Button31_Click(sender As Object, e As EventArgs) Handles Button31.Click
        ...
        Else
            ...
            Catch ex As Exception
                'comprobartipoingreso()
                MsgBox("Para mantener la integridad del sistema, no se permite eliminar clientes con ventas", MsgBoxStyle.Exclamation, "CTRL+y")
            End Try
        End If
    ...
    Private Sub calendario_DateChanged(sender As Object, e As DateRangeEventArgs) Handles calendario.DateChanged
        GroupBox14.Text = "Información del Día"

        consultacortecalendario()
        desgloseventascalendario()
    ...
    Function desglosecompras()
        ...
        conexionMysql.Close()
    End Function
    Function desgloseventascalendario()
        Dim fechacompleta, fecha, fechafinal, fechacaja, horacaja As String
    ...
    Function desgloseventas()
        ...
        If id > 0 Then
            ...
            '        Sql = "select venta.idventa, ventaind.idventaind,tipoventa.tipoventa, ventaind.idproducto, ventaind.actividad, ventaind.cantidad, ventaind.costo,(ventaind.cantidad * ventaind.costo) as Total, venta.anticipo,venta.resto, venta.hora from ventaind, venta,tipoventa where ventaind.idventa = venta.idventa and venta.tipoventa=tipoventa.idtipoventa and fecha='" & fechacompleta & "';"
            '        Sql = "select venta.idventa, ventaind.idventaind, ventaind.actividad, ventaind.cantidad, ventaind.costo,(ventaind.cantidad * ventaind.costo) as Total, ventaind.idproducto, venta.hora,venta.fecha from ventaind, venta where ventaind.idventa = venta.idventa and fecha between '" & fecha & "' and '" & fechafinal & "';"
            Sql = "select venta.idventa, ventaind.idventaind,venta.tipoventa, ventaind.actividad, ventaind.cantidad, ventaind.costo,(ventaind.cantidad * ventaind.costo) as Total,venta.anticipo,venta.resto, ventaind.idproducto, venta.hora,venta.fecha from ventaind, venta where ventaind.idventa = venta.idventa and fecha between '" & fechainicial & "' and '" & fechafinal & "';"
            'Sql = "select venta.idventa, ventaind.idventaind, ventaind.actividad, ventaind.cantidad, ventaind.costo,(ventaind.cantidad * ventaind.costo) as Total, servicios_ventas.anticipo, ventaind.idproducto, venta.hora,venta.fecha from ventaind, venta, servicios_ventas where ventaind.idventa = venta.idventa and venta.idventa= servicios_ventas.idventa and venta.fecha='" & fechacompleta & "';"
            'Sql = "select venta.idventa, ventaind.idventaind, tipoventa.tipoventa, ventaind.actividad, ventaind.cantidad, ventaind.costo,(ventaind.cantidad * ventaind.costo) as Total, servicios_ventas.anticipo, ventaind.idproducto, venta.hora,venta.fecha from tipoventa, ventaind, venta, servicios_ventas where ventaind.idventa = venta.idventa and venta.idventa= servicios_ventas.idventa and venta.tipoventa = tipoventa.idtipoventa and venta.fecha='" & fechacompleta & "';"
            'Sql = "select venta.idventa, ventaind.idventaind, ventaind.actividad, ventaind.cantidad, ventaind.costo,(ventaind.cantidad * ventaind.costo) as Total, servicios_ventas.anticipo, ventaind.idproducto, venta.hora,venta.fecha from servicios_ventas, ventaind, venta where ventaind.idventa = venta.idventa  and venta.fecha='" & fechacompleta & "';"
        ...
        Try
            ...
            Else
                ...
                For C1j = 0 To C1i - 2
                    ...
                    'cantidadpaquete = ccgrilla.R|1ows(C1j).Cells(8).Value
                    ...
                    Dim Sql22 As String
                    err = 1
                    Sql22 = "INSERT INTO `compramercancia` (`idcompra`, `idproducto`, `costo`, `cantidad`, `fecha`, `hora`,`totalcompra`) VALUES (" & btnidcompramercancia.Text & ", '" & c1idcompra & "', " & C1costo & ", " & C1cantidad & ", '" & fecha & "', '" & hora & "','" & ctxtcomprado2.Text & "');"
                    Dim cmd22 As New MySqlCommand(Sql22, conexionMysql)
                    cmd22.ExecuteNonQuery()
                    conexionMysql.Close()
                Next
    ...
    Private Sub ctxtnombre_TextChanged(sender As Object, e As EventArgs) Handles ctxtnombre.TextChanged
        ...
        '    listaclientes.Items.Add(reader.GetString(0).ToString)
        'Next
        If estadoBusquedaClientes = 1 Then
        ...
        Else
            ...
            Else
                ...
                ulistaclientes.Visible = True
                ulistaclientes.Items.Clear()
                ...
                Else
                    ...
                    For i = 1 To cantidad
                        ...
                        ulistaclientes.Items.Add(reader.GetString(0).ToString)
                    Next
    ...
    Function valoresiniciales()
        ...
        conexionMysql.Open()
        Dim Sql As String
        Sql = "INSERT INTO `cliente` (`nombre`, `ap`, `am`, `rfc`, `direccion`, `telefono`, `correo`) VALUES ('usuario', 'usuario', 'usuario', '0', '0', '0', '0');"
        Dim cmd As New MySqlCommand(Sql, conexionMysql)
        cmd.ExecuteNonQuery()
        conexionMysql.Close()
        ...
        conexionMysql.Open()
        Dim Sql3 As String
        Sql3 = "INSERT INTO `tipo_usuario` (`tipo_usuario`, `tipo`) VALUES ('1', 'ADMINISTRADOR');"
        Dim cmd3 As New MySqlCommand(Sql3, conexionMysql)
        cmd3.ExecuteNonQuery()
        conexionMysql.Close()
        ...
        conexionMysql.Open()
        Dim Sql4 As String
        Sql4 = "INSERT INTO `tipo_usuario` (`tipo_usuario`, `tipo`) VALUES ('2', 'TRABAJADOR');"
        Dim cmd4 As New MySqlCommand(Sql4, conexionMysql)
        cmd4.ExecuteNonQuery()
        conexionMysql.Close()
        ...
        conexionMysql.Open()
        Dim Sql5 As String
        Sql5 = "INSERT INTO `proveedor` (`nombre_empresa`, `nombre_encargado`, `ap_encargado`, `am_encargado`, `ciudad`, `estado`, `telefono`, `correo`) VALUES ('INDEFINIDO', 'INDEFINIDO', 'INDEFINIDO', 'INDEFINIDO', '00', '00', '00', '00');"
        Dim cmd5 As New MySqlCommand(Sql5, conexionMysql)
        cmd5.ExecuteNonQuery()
        conexionMysql.Close()
        ...
        conexionMysql.Open()
        Dim Sql5X As String
        Sql5X = "INSERT INTO `tipo_corte` (`idtipo_corte`, `tipo`, `estado`) VALUES ('1', 'USUARIO', '1');"
        ...
        Sql5X1 = "INSERT INTO `tipo_corte` (`idtipo_corte`, `tipo`, `estado`) VALUES ('2', 'TIEMPO', '0');"
        ...
        conexionMysql.Open()
        Dim Sql6 As String
        Sql6 = "INSERT INTO `tipoproducto` (`tipo`) VALUES ('INDEFINIDO');"
        Dim cmd6 As New MySqlCommand(Sql6, conexionMysql)
        cmd6.ExecuteNonQuery()
        conexionMysql.Close()
    ...
    Private Sub txtfecharegistroventa_TextChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub txthoraregistroventa_TextChanged(sender As Object, e As EventArgs)
    ...
    End Sub
    Function cargarDatosVentaServicio()
        obtener_chticket_Chcambio_venta()
        cargarformadepago()
        obtenerfolio()
        Dim tipo As Integer
    ...
    Function cargaragenda()
        ...
        Try
            ...
            conexionMysql.Open()
            Dim Sql As String
            Sql = "select * from agenda where fecha='" & fecha & "';"
            Dim cmd As New MySqlCommand(Sql, conexionMysql)
            Dim dt As New DataTable
            Dim da As New MySqlDataAdapter(cmd)
            'cargamos el formulario  resumen
            ...
            agendagrilla.Columns(1).Width = 600
...
ADD COLUMN `cantidad_mayoreo` INT(11) NULL AFTER `idtipoproducto`;"
    ...
    Private Sub Button89_Click(sender As Object, e As EventArgs) Handles Button89.Click
        ...
        Dim formulario As New FRMNuevoproducto
    ...
    Private Sub agtxtid_TextChanged(sender As Object, e As EventArgs)
        ...
        Else
            Try
                ...
                conexionMysql.Open()
                Dim Sql As String
                Sql = "select * from agenda where idagenda='" & agtxtid.Text & "';"
                Dim cmd As New MySqlCommand(Sql, conexionMysql)
                reader = cmd.ExecuteReader()
                reader.Read()
                AGtxtDescripcion.Text = reader.GetString(1).ToString()
                AGtxtTotal.Text = reader.GetString(2).ToString()
                reader.Close()
    ...
    Private Sub ulistaclientes_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ulistaclientes.SelectedIndexChanged
    ...
    Private Sub chRespaldo_CheckedChanged(sender As Object, e As EventArgs) Handles chRespaldo.CheckedChanged
        Try
            Dim valor As Integer
            valor = 0
            If chRespaldo.Checked = True Then
                valor = 1
            ElseIf chRespaldo.Checked = False Then
                valor = 0
            End If
            ...
            conexionMysql.Open()
            Dim Sql22 As String
            Sql22 = "UPDATE `datos_empresa` SET `respaldo_auto` = '" & valor & "';"
            Dim cmd22 As New MySqlCommand(Sql22, conexionMysql)
            cmd22.ExecuteNonQuery()
            conexionMysql.Close()
            'MsgBox("Valor Actualizado", MsgBoxStyle.Information, "CTRL+y")
    ...
    Private Sub btventas_DoubleClick(sender As Object, e As EventArgs) Handles btventas.DoubleClick
        'ABRIRCAJATICKET()

    End Sub

    Private Sub btventas_KeyDown(sender As Object, e As KeyEventArgs) Handles btventas.KeyDown
    ...
    Private Sub ulistaclientes_DoubleClick(sender As Object, e As EventArgs) Handles ulistaclientes.DoubleClick
        ...
        Dim idCliente As Integer
        nombreCompleto = ulistaclientes.Text
        ulistaclientes.Visible = False
